...
APP_NAME="z-biz-tool-note"           # .app bundle 名称 (来自 tauri.conf.json productName)
BUNDLE_ID="com.zifang.z-biz-tool-note"  # bundle identifier
DISPLAY_NAME="z-biz-tool-note"
